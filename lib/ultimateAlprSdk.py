    ...
    def swig_import_helper():
        ...
        try:
            fp, pathname, description = imp.find_module(
                "_ultimateAlprSdk", [dirname(__file__)]
            )
        except ImportError:
...
class UltAlprSdkResult(_object):
    ...
    __setattr__ = lambda self, name, value: _swig_setattr(
        self, UltAlprSdkResult, name, value
    )
    __swig_getmethods__ = {}
    ...
    def code(self):
        return _ultimateAlprSdk.UltAlprSdkResult_code(self)

    def phrase(self):
        return _ultimateAlprSdk.UltAlprSdkResult_phrase(self)

    def json(self):
        return _ultimateAlprSdk.UltAlprSdkResult_json(self)

    def numPlates(self):
        return _ultimateAlprSdk.UltAlprSdkResult_numPlates(self)

    def numCars(self):
        return _ultimateAlprSdk.UltAlprSdkResult_numCars(self)

    def isOK(self):
        return _ultimateAlprSdk.UltAlprSdkResult_isOK(self)
...
class UltAlprSdkParallelDeliveryCallback(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(
        self, UltAlprSdkParallelDeliveryCallback, name, value
    )
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(
        self, UltAlprSdkParallelDeliveryCallback, name
    )
    __repr__ = _swig_repr
    ...
    def onNewResult(self, *args):
        return _ultimateAlprSdk.UltAlprSdkParallelDeliveryCallback_onNewResult(
            self, *args
        )
...
UltAlprSdkParallelDeliveryCallback_swigregister = (
    _ultimateAlprSdk.UltAlprSdkParallelDeliveryCallback_swigregister
)
...
class UltAlprSdkEngine(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(
        self, UltAlprSdkEngine, name, value
    )
    __swig_getmethods__ = {}
    ...
    if _newclass:
        init = staticmethod(_ultimateAlprSdk.UltAlprSdkEngine_init)
    __swig_getmethods__["deInit"] = lambda x: _ultimateAlprSdk.UltAlprSdkEngine_deInit
    if _newclass:
        deInit = staticmethod(_ultimateAlprSdk.UltAlprSdkEngine_deInit)
    __swig_getmethods__["process"] = lambda x: _ultimateAlprSdk.UltAlprSdkEngine_process
    if _newclass:
        process = staticmethod(_ultimateAlprSdk.UltAlprSdkEngine_process)
    __swig_getmethods__[
        "exifOrientation"
    ] = lambda x: _ultimateAlprSdk.UltAlprSdkEngine_exifOrientation
    if _newclass:
        exifOrientation = staticmethod(
            _ultimateAlprSdk.UltAlprSdkEngine_exifOrientation
        )
    __swig_getmethods__[
        "requestRuntimeLicenseKey"
    ] = lambda x: _ultimateAlprSdk.UltAlprSdkEngine_requestRuntimeLicenseKey
    if _newclass:
        requestRuntimeLicenseKey = staticmethod(
            _ultimateAlprSdk.UltAlprSdkEngine_requestRuntimeLicenseKey
        )
    __swig_getmethods__["warmUp"] = lambda x: _ultimateAlprSdk.UltAlprSdkEngine_warmUp
    if _newclass:
        warmUp = staticmethod(_ultimateAlprSdk.UltAlprSdkEngine_warmUp)
